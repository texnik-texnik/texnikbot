...
*/
    ob_start();
    $API_KEY = '1859339943:AAHens1THVKCt1oZaQ33-W4Uri14NLrnZnA';
...
Вы можете использовать следующие ссылки для подключения
    ",
    'reply_markup'=>json_encode([
    'inline_keyboard'=>[[['text'=>"💬 Админ",'url'=>"https://t.me/IT_TEXNIK"],['text'=>"📢 Наш канал",'url'=>"https://t.me/news_channel_mail"]],]])
    ]);
    }
    if($text == '📝 Начать!'){
    bot('sendMessage',[
...
",
   ...
   'reply_markup'=>json_encode([
   'inline_keyboard'=>[
    [['text'=>"📢",'url'=>"https://t.me/$yourchannel"],['text'=>"💬",'url'=>"https://t.me/news_channel_mail"]],
    ]])
    ]);
    }
